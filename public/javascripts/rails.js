...
<meta content="7a3f3a7209435b370f7482c6f287318eaa041891" name="csrf-token" />
  ...
  <body class="logged_out page-blob  env-production">
    ...
    <ul class="actions">
        ...
        <li>
          <a href="/rails/jquery-ujs/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '7a3f3a7209435b370f7482c6f287318eaa041891'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/rails/jquery-ujs/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '7a3f3a7209435b370f7482c6f287318eaa041891'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/rails/jquery-ujs/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '7a3f3a7209435b370f7482c6f287318eaa041891'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/rails/jquery-ujs/watchers" title="Watchers" class="tooltipped downwards">1,497</a></li>
  ...
  <ul class="tabs">
    ...
    <li><a href="/rails/jquery-ujs/pulls" highlight="repo_pulls">Pull Requests (3)</a></li>
      ...
      <li><a href="/rails/jquery-ujs/issues" highlight="issues">Issues (8)</a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/rails/jquery-ujs/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="7a3f3a7209435b370f7482c6f287318eaa041891" /></div>
  ...
  <input type="text" spellcheck="false" class="url-field" />
        <span style="display:none" id="clippy_329" class="url-box-clippy"></span>
      <span id="clippy_tooltip_clippy_329" class="clippy-tooltip tooltipped" title="copy to clipboard">
      ...
      <param NAME="FlashVars" value="id=clippy_329&amp;copied=&amp;copyto=">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?v5"
             ...
             FlashVars="id=clippy_329&amp;copied=&amp;copyto="
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div id="footer" >
      ...
      <div class="lower_footer">
        ...
        <![if !IE]><div id="legal"><![endif]>
              ...
              <p>&copy; 2011 <span id="_rrt" title="0.05638s from fe7.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
